    ...
    <>
      <div className='sidebar'>
        <div className='sidebar-element border-mint'>
          ...
          <iframe src="https://www3.cbox.ws/box/?boxid=3549431&boxtag=Q34sFz" width="100%" height="320" allowtransparency="yes" allow="autoplay" frameBorder="0" marginHeight="0" marginWidth="0" scrolling="auto"></iframe>
        </div>
        <Favorites />
        <Fashion />
      </div>
