  ...
  return (
    <>
      <div className="sidebar-element border-yellow">
        ...
        <p><Heart color="mint" /> DereSute fav SSRs <img src="img/heartwithbow.gif" alt="heart with bow" /></p>
        <p><Heart color="blue" /> DereSute fav units <img src="img/colorfulstars.gif" alt="colorful stars gif" /></p>
        ...
        <p><Heart color="yellow" /> Cute bird videos <img src="img/cockatiel.gif" alt="cockatiel" /></p>
      </div>
    </>
  )
}
