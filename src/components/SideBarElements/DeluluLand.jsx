  ...
  return (
    <>
      <div className="sidebar-element border-sax">
        <h1 className="bg-sax2">delulu<span className="text-pink">❤</span>land</h1>
        <img src="img/girlwritinginbed.gif" alt="girl writing in bed" className="center-img"/>
        <p><Heart color="pink" /> <a href="https://archiveofourown.org/users/LilacRibbons" className="text-mint">My fics on AO3</a> <img src="img/book.gif" alt="open book with a heart" /></p>
