  ...
  return (
    <>
      <div className="sidebar-element border-sax">
        ...
        <p><Heart color="lilac" /> Fangirling / rants</p>
        <p><Heart color="pink" /> Questionnaires I've found on Tumblr</p>
        <p><Heart color="yellow" /> Log of horrible fics I've written through the years</p>
      </div>
    </>
  )
}
